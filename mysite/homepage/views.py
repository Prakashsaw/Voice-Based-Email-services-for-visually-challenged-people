    ...
    if request.method == 'POST':
        ...
        if x == 'yes':
            ...
            if say == 'yes' or say == 'yas' or say == 'yash' or say == 'yeah':
                ...
                while flagconf:
                    try:
                        tts = gtts.gTTS(text=audio_msg, lang='en', slow=False)
                        tts.save(filename)
                        flagconf = False
                    except:
                        print('Trying again')
    ...
    for part in msg.walk():
        ...
        if bool(filename):
            ...
            with open(filepath, "wb") as f:
                ...
                i = i + str(1)
                path = 'D:/All_Project_Folder/Mini project G-21/Virtual-Assistance-for-The-Blind/mysite'
